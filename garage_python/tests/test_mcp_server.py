...
class TestMcpTools:
    ...
    def test_rag_get_document_by_id_found(self) -> None:
        ...
        with patch("garage_rag.mcp_server.server.session_scope") as mock_scope:
            ...
            mock_authors_chain = (
                mock_session.query.return_value.join.return_value.filter.return_value.order_by.return_value.all
            )
            mock_authors_chain.return_value = [("Alice",), ("Bob",)]
    ...
    def test_rag_get_document_by_location_truncated(self) -> None:
        ...
        with patch("garage_rag.mcp_server.server.session_scope") as mock_scope:
            ...
            mock_authors_chain.return_value = []
    ...
    def test_rag_list_sources(self) -> None:
        ...
        with patch("garage_rag.mcp_server.server.session_scope") as mock_scope:
            ...
            mock_sources_chain = mock_session.query.return_value.outerjoin.return_value.outerjoin.return_value.group_by
            mock_sources_chain.return_value.order_by.return_value.all.return_value = rows
    ...
    def test_rag_list_authors(self) -> None:
        ...
        with patch("garage_rag.mcp_server.server.session_scope") as mock_scope:
            ...
            mock_authors_list_chain = (
                mock_session.query.return_value.outerjoin.return_value.outerjoin.return_value.group_by
            )
            mock_authors_list_chain.return_value.order_by.return_value.limit.return_value.all.return_value = rows
