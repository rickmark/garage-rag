...
2. **Verify Full Disk Access**: If indexing `~/Library/Messages` or `~/Library/Mail`, make sure **Full Disk Access** is granted to **Garage** or your Terminal application under **System Settings → Privacy & Security**.
