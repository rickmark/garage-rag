...
_TOOL_NAME_TOKENS: tuple[str, ...] = (
    "acrobat", "microsoft word", "microsoft excel", "microsoft powerpoint",
    "latex", "pdftex", "pdflatex", "xetex", "ghostscript", "quartz",
    "openpyxl", "python-pptx", "python-docx", "steve canny",
    "libreoffice", "openoffice", "pages", "keynote", "numbers",
    "wkhtmltopdf", "reportlab", "tcpdf", "fpdf", "word for", "excel for",
    "adobe", "indesign", "illustrator", "photoshop", "canva", "google docs",
    "unknown", "user", "admin", "administrator", "owner",
)
